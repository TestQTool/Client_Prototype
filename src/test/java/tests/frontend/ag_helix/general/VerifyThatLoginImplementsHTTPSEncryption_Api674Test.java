...
public class VerifyThatLoginImplementsHTTPSEncryption_Api674Test {

    @Test(description = "Verify that login implements HTTPS encryption")
    public void verifyThatLoginImplementsHTTPSEncryption() {
