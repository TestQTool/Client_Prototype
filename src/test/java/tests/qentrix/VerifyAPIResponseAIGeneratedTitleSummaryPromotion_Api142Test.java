...
public class VerifyAPIResponseAIGeneratedTitleSummaryPromotion_Api142Test {
    ...
    public void verifyAPIResponseForAIGeneratedTitleAndSummaryForPromotionRequest() {
        ...
        Response response = given()
                ...
                .body(QentrixTestData.requestBody("VerifyAPIResponseAIGeneratedTitleSummaryPromotion_Api142.json"))
        .when()
                .post("/api/auth/");
