...
public class ExtentReportManager {
    ...
    public static void logJson(String json) {
       ...
       // Setup.extentTest.get().info(MarkupHelper.createCodeBlock(jsonString, MarkupHelper.CodeLanguage.JSON));
    }
    public static void logHeaders(List<io.restassured.http.Header> headerList) {
    ...
    public static void logSkipDetails(String log) {
        Setup.extentTest.get().skip(MarkupHelper.createLabel(log, ExtentColor.ORANGE));
    }
}
