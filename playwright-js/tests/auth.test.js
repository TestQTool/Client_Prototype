...
test.describe('Auth', () => {
    ...
    test('594: Verify that user authentication API returns correct response @smoke @regression', async ({ authPage }) => {
        await test.step('Send POST request to auth endpoint Ã¢â€ â€™ Request should be sent | Include valid credentials in payload Ã¢â€ â€™ Payload should be formatted correctly | Verify response status code Ã¢â€ â€™ Should return 200 OK | Verify response contains auth token Ã¢â€ â€™ Token should be present | Verify token format is valid Ã¢â€ â€™ Token should follow expected format', async () => {
            ...
            await authPage.verifyPageLoaded();
        });
    });

    test('597: Verify that profile update fails with invalid email format @regression', async ({ authPage }) => {
    ...
    test('38: Verify that user can successfully register with valid credentials @regression', async ({ authPage }) => {
    ...
    test('601: Verify that user can reset password successfully @regression', async ({ authPage }) => {
    ...
    test('596: Verify that user can update profile information @regression', async ({ authPage }) => {
    ...
    test('590: Verify that user can login with valid credentials @regression', async ({ authPage }) => {
    ...
    test('614: Verify that user can access dashboard after successful login @regression', async ({ authPage }) => {
    ...
    test('606: Verify that user can change password from profile settings @regression', async ({ authPage }) => {
    ...
    test('647: Verify that user can view account activity history @regression', async ({ authPage }) => {
    ...
    test('607: Verify that password change fails with incorrect current password @regression', async ({ authPage }) => {
    ...
    test('593: Verify that user can logout successfully @regression', async ({ authPage }) => {
    ...
    test('603: Verify that user data API returns complete user information @regression', async ({ authPage }) => {
    ...
    test('610: TC_Verify that user can view account information @regression', async ({ authPage }) => {
